...
async def set_notification_preferences(
    ...
    try:
        return await notification_service.create_or_update_preferences(user.id, preferences.dict())
...
async def get_user_notifications(
    ...
    try:
        return await notification_service.get_user_notifications(user.id, filter_read, limit, offset)
    except Exception as e:
...
async def get_notifications_by_type(
    ...
    try:
        return await notification_service.get_notifications_by_type(user.id, notification_type, limit, offset)
