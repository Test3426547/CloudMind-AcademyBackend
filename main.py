...
from routers import auth, ai_tutor, quiz, code_sandbox, gamification, learning_path, analytics, video_content, plagiarism, virtual_lab
...
app.include_router(virtual_lab.router, prefix="/api/v1")  # Add the new virtual lab router
